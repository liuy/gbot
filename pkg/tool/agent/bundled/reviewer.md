...
- **LSP beats Grep for code structure**: tracing impact, finding callers, checking signatures — use Lsp (impact/references/hover), not Grep. Grep is for text/comments only.
