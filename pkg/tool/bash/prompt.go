...
func bashPrompt() string {
	return "Executes a given bash command and returns its output.\n\n" +
		...
		" - You may specify an optional timeout in milliseconds (up to 3600000ms / 60 minutes). By default, your command will timeout after 120000ms (2 minutes). Do NOT use the system " + bt + "timeout" + bt + " command — set the \"timeout\" JSON parameter instead.\n" +
