...
export const dict = {
  ...
  targetLocal: 'Local',
  backToLocal: 'Switch to local',
  remoteSection: 'REMOTE ENDPOINT',
  remoteNameLabel: 'Name',
  remoteHostLabel: 'Host',
  remotePortLabel: 'Port',
  remoteSaved: 'Saved',
  remoteAdd: 'Add Endpoint',
  remoteDelete: 'Delete',
  remoteNameRequired: 'Name is required',
  remoteNameUnique: 'Names must be unique',
  remoteHostRequired: 'Host is required',
  remoteHostInvalid: 'Invalid host (hostname only — no port or path)',
  remotePortInvalid: 'Port must be 1-65535',
  remoteDesktopSection: 'DESKTOPS',
  sidebarRemoteDesktop: 'Desktops',
  rdAdd: 'Add Desktop',
  rdEditTitle: 'Edit',
  rdNameLabel: 'Name',
  rdAddrLabel: 'Address',
  ...
  rdStateFailed: 'Connection failed',
  ...
  jsonSheetEmpty: 'File not found — it is created on first save',
  jsonSheetError: 'Failed to load settings.json',
