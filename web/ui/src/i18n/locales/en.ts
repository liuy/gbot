...
export const dict = {
  ...
  appLogCopy: 'Copy',
  appLogClear: 'Clear',
  appLogClearConfirm: 'Clear all app logs?',
  appLogScrollBottom: 'Scroll to bottom',
  appLogCopied: 'Copied',
  ...
  ctxLoading: 'Loading...',
  ctxMsgBreakdown: 'Message breakdown',
  ctxToolCalls: 'Tool calls',
  ctxToolResults: 'Tool results',
  ctxAttachments: 'Attachments',
  ctxAssistantText: 'Assistant text',
  ctxUserText: 'User text',
  ctxTopTools: 'Top tools',
  ctxSystemPrompt: 'System prompt',
  ctxMemoryFiles: 'Memory files',
  ctxSystemTools: 'System tools',
  ctxMcpLoaded: 'MCP tools loaded',
  ctxMcpDeferred: 'MCP tools deferred',
  ctxAgents: 'Agents',
  ctxSkills: 'Skills',
  ctxApiUsage: 'API usage',
  ctxInput: 'Input',
  ctxOutput: 'Output',
  ...
  ctxCatSystemTools: 'System tools',
  ctxCatMcpTools: 'MCP tools',
  ctxCatCustomAgents: 'Custom agents',
